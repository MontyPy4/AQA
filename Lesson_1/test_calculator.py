...
@pytest.fixture
def calculator():
    return Calculator() # будет инициализироваться копия класса калькулятор
...
@pytest.mark.xfail(reason="Метод в процессе разработки") # чтобы тесты не блокировали код и обходили
